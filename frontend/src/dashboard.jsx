...
import { Inbox, Edit3, Settings, X, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="inbox-container">
      <div className="empty-state">
        ...
        <h3 className="empty-state-title">Email History Unavailable</h3>
        <p className="empty-state-text">
          The email history feature is not yet implemented. Please check back later or contact support to enable this feature.
        </p>
      </div>
    </div>
  );
